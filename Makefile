...
BUILD_ARGS=-ldflags "-s -w -X github.com/timo-reymann/imap-to-chat-bridge/pkg/buildinfo.GitSha=$(COMMIT_REF) -X github.com/timo-reymann/imap-to-chat-bridge/pkg/buildinfo.Version=$(VERSION) -X github.com/timo-reymann/imap-to-chat-bridge/pkg/buildinfo.BuildTime=$(NOW)"
BIN_PREFIX="dist/imap-to-chat-bridge_"
